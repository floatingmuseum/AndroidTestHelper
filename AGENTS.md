...
- Current behavior:
  ...
  - Clicking a table header hides that column; restore controls must remain accessible even when every column is hidden. Long cells wrap; headers and rows share widths and horizontal scrolling.
