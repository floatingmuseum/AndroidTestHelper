...
@Composable
fun ScreenRecordFloatingButton(
    deviceLabel: String,
    isPreparing: Boolean,
    isStopping: Boolean,
    onStop: () -> Unit,
    ...
    Surface(
        ...
        Row(
            ...
            Column(verticalArrangement = Arrangement.spacedBy(2.dp)) {
                Text(
                    text = when {
                        isPreparing -> strings.t("device.screen_record.preparing_title")
                        isStopping -> strings.t("device.screen_record.stopping_title")
                        else -> strings.t("device.screen_record.recording_title")
                    },
